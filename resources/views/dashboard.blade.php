        ...
        <div class="flex items-center justify-start mb-4">
            <div>
                <a href={{ route('products.create') }}
                    ...
                    Add New Product</a>
                <a href="#"
                    class="py-2.5 px-4 inline-flex items-center text-dark dark:text-white rounded-lg bg-gray-100 hover:bg-gray-200 dark:hover:bg-gray-600 dark:bg-gray-700">+
                    Add New orders</a>
            </div>
        </div>
                        ...
                        <footer class="flex items-center justify-between mb-2">
                            <div class="flex items-center">
                                ...
                                <p class="text-sm text-gray-600 dark:text-gray-400"><time pubdate datetime="2022-02-08"
                                        title="February 8th, 2022"> 01/03/2023
                                        4:15 PM</time></p>
                            </div>
                    ...
                    <div
                        ...
                        <div>
                            <button
                                ...
                                days <svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                                    xmlns="http://www.w3.org/2000/svg">
